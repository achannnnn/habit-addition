...
public class LocalNotificationsHandler: NSObject, NotificationHandlerProtocol {
    ...
    func makePendingNotificationRequestJSObject(_ request: UNNotificationRequest) -> JSObject {
        ...
        // SwiftPM Capacitor binary may not expose JSTypes conversion APIs in all toolchains.
        // Keep payload minimal to avoid type-mismatch when converting [String: Any] to JSValue.
        _ = request.content.userInfo
